...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_UPD_GROUP_DUNGEON_LEVEL,
    CHAR_UPD_GROUP_AFFIX,
    CHAR_DEL_DATA_INSTANCE_BY_INSTANCE,
    CHAR_INS_VIRTUAL_TEMPLATE,
    CHAR_SEL_ITEM_LEVEL_SLOTS,
    CHAR_UPD_ITEM_LEVEL_SLOTS,
    CHAR_DEL_ITEM_LEVEL_SLOTS,

    CHAR_SEL_NUM_TALENTS_FREE,

    CHAR_SEL_CUSTOM_TALENTS,
    CHAR_DEL_CHAR_CUSTOM_TALENTS,
    CHAR_DEL_CHAR_CUSTOM_TALENT_BY_LOADOUT,
    CHAR_DEL_CHAR_CUSTOM_TALENT_LEADOUT,
    CHAR_INS_CHAR_CUSTOM_TALENT,
    CHAR_UPD_ACCOUNT_BANK_TAB_INFO,
    CHAR_UPD_ACCOUNT_BANK_TAB_TEXT,
    CHAR_DEL_ACCOUNT_BANK_ITEM,
    CHAR_INS_ACCOUNT_BANK_ITEM,
    CHAR_INS_ACCOUNT_BANK_TAB,
    CHAR_DEL_ACCOUNT_BANK_TAB,

    CHAR_INS_SOCKET_SUPPORT,
    CHAR_DEL_SOCKET_SUPPORT,
