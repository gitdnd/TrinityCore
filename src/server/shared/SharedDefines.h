...
enum SpellEffects
{
    ...
    SPELL_EFFECT_VIRTUAL_ITEM_QUALITY_UPGRADE       = 168,
    SPELL_EFFECT_VIRTUAL_ITEM_LEVEL_UPGRADE         = 169,
...
constexpr uint32 SkillByQuestSort(int32 QuestSort)
{
    switch (QuestSort)
    {
        ...
        case QUEST_SORT_TRANSMUTATION:  return SKILL_TRANSMUTATION;
    }
    return 0;
}
...
enum CustomSpells : uint32
{
    ...
    SPELL_EXIGENT_IMPOSITION = 180245,
    SPELL_EXIGENT_IMPOSITION_TRIGGER = 180246,
