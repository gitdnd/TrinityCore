...
struct MapEntry
{
    ...
    bool IsDungeon() const { return InstanceType == MAP_INSTANCE || InstanceType == MAP_RAID || ID == 768 || ID == 770 || ID == 44 || ID == 776; } // 768 The Timeways, 770 The Ring of Valor, 44 Scarlet Monastery, 776 Venture Co. Mine
    bool IsNonRaidDungeon() const { return InstanceType == MAP_INSTANCE || ID == 768 || ID == 770 || ID == 44 || ID == 776; } // 768 The Timeways, 770 The Ring of Valor, 44 Scarlet Monastery, 776 Venture Co. Mine
    bool Instanceable() const { return InstanceType == MAP_INSTANCE || InstanceType == MAP_RAID || InstanceType == MAP_BATTLEGROUND || InstanceType == MAP_ARENA || ID == 768 || ID == 770 || ID == 44 || ID == 776; } // 768 The Timeways, 770 The Ring of Valor, 44 Scarlet Monastery, 776 Venture Co. Mine
