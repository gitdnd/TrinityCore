...
enum LfgTeleportError
{
    ...
    LFG_TELEPORTERROR_CANT_DO_THAT_RIGHT_NOW     = 7,
...
class TC_GAME_API LFGMgr
{
    ...
    public:
        ...
        LfgJoinResult JoinLfg(Player* player, uint8 roles, LfgDungeonSet& dungeons, std::string const& comment, LfgGroupType groupType, uint32* affixes);
        /// Leaves lfg
    ...
    private:
        ...
        void SetAffixData(ObjectGuid guid, uint32* affixes);
