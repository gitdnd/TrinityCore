...
enum WorldFloatConfigs
{
    ...
    CONFIG_ITEMGEN_STATWEIGHT_HIT_SPELL_RATING,
    CONFIG_ITEMGEN_STATWEIGHT_HASTE_SPELL_RATING,
    CONFIG_ITEMGEN_STATWEIGHT_CRIT_SPELL_RATING,
    ...
    CONFIG_ITEMGEN_STATWEIGHT_HIT_RANGED_RATING,
    CONFIG_ITEMGEN_STATWEIGHT_CRIT_RANGED_RATING,
    CONFIG_ITEMGEN_STATWEIGHT_HASTE_RANGED_RATING,
    CONFIG_ITEMGEN_STATWEIGHT_RANGED_ATTACK_POWER,
    CONFIG_ITEMGEN_STATWEIGHT_EXPERTISE_RATING,
    CONFIG_ITEMGEN_STATWEIGHT_HIT_MELEE_RATING,
    CONFIG_ITEMGEN_STATWEIGHT_CRIT_MELEE_RATING,
    CONFIG_ITEMGEN_STATWEIGHT_HASTE_MELEE_RATING,
