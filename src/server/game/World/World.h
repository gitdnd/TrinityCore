...
enum WorldFloatConfigs : uint32
{
    ...
    CONFIG_ITEMGEN_STATGEN_POOLMOD,
    CONFIG_ITEMGEN_STATGEN_LOWBOUND,
    CONFIG_ITEMGEN_STATGEN_HIGHBOUND,
    CONFIG_ITEMGEN_STATGEN_PRIMARY_MOD,
    CONFIG_ITEMGEN_STATGEN_SECONDARY_MOD,
    CONFIG_ITEMGEN_STATWEIGHT_STAMINA,
    CONFIG_ITEMGEN_STATWEIGHT_AGILITY,
    CONFIG_ITEMGEN_STATWEIGHT_INTELLECT,
    CONFIG_ITEMGEN_STATWEIGHT_STRENGTH,
    CONFIG_ITEMGEN_STATWEIGHT_SPIRIT,
    CONFIG_ITEMGEN_STATWEIGHT_DEFENSE_SKILL_RATING,
    CONFIG_ITEMGEN_STATWEIGHT_DODGE_RATING,
    CONFIG_ITEMGEN_STATWEIGHT_PARRY_RATING,
    CONFIG_ITEMGEN_STATWEIGHT_BLOCK_RATING,
    CONFIG_ITEMGEN_STATWEIGHT_BLOCK_VALUE,
    CONFIG_ITEMGEN_STATWEIGHT_HIT_RATING,
    CONFIG_ITEMGEN_STATWEIGHT_HASTE_RATING,
    CONFIG_ITEMGEN_STATWEIGHT_CRIT_RATING,
    CONFIG_ITEMGEN_STATWEIGHT_MANA_REGENERATION,
    CONFIG_ITEMGEN_STATWEIGHT_SPELL_POWER,
    CONFIG_ITEMGEN_STATWEIGHT_SPELL_PENETRATION,
    CONFIG_ITEMGEN_STATWEIGHT_SPELL_HEALING_DONE,
    CONFIG_ITEMGEN_STATWEIGHT_EXPERTISE_RATING,
    CONFIG_ITEMGEN_STATWEIGHT_ARMOR_PENETRATION_RATING,
    CONFIG_ITEMGEN_STATWEIGHT_ATTACK_POWER,
    CONFIG_ITEMGEN_STATWEIGHT_HEALTH_REGEN,
    CONFIG_ITEMGEN_STATWEIGHT_MAGICFIND,
    CONFIG_ITEMGEN_SLOTWEIGHT_HEAD,
    CONFIG_ITEMGEN_SLOTWEIGHT_CHEST,
    CONFIG_ITEMGEN_SLOTWEIGHT_ROBE,
    CONFIG_ITEMGEN_SLOTWEIGHT_LEGS,
    CONFIG_ITEMGEN_SLOTWEIGHT_2HWEAPON,
    CONFIG_ITEMGEN_SLOTWEIGHT_SHOULDERS,
    CONFIG_ITEMGEN_SLOTWEIGHT_HANDS,
    CONFIG_ITEMGEN_SLOTWEIGHT_WAIST,
    CONFIG_ITEMGEN_SLOTWEIGHT_FEET,
    CONFIG_ITEMGEN_SLOTWEIGHT_WRISTS,
    CONFIG_ITEMGEN_SLOTWEIGHT_NECK,
    CONFIG_ITEMGEN_SLOTWEIGHT_CLOAK,
    CONFIG_ITEMGEN_SLOTWEIGHT_HOLDABLE,
    CONFIG_ITEMGEN_SLOTWEIGHT_SHIELD,
    CONFIG_ITEMGEN_SLOTWEIGHT_WEAPON,
    CONFIG_ITEMGEN_SLOTWEIGHT_WEAPONMAINHAND,
    CONFIG_ITEMGEN_SLOTWEIGHT_WEAPONOFFHAND,
    CONFIG_ITEMGEN_SLOTWEIGHT_FINGER,
    CONFIG_ITEMGEN_SLOTWEIGHT_TRINKET,
    CONFIG_ITEMGEN_SLOTWEIGHT_RANGED,
    CONFIG_ITEMGEN_SLOTWEIGHT_RANGEDRIGHT,
    CONFIG_ITEMGEN_SLOTWEIGHT_THROWN,
    CONFIG_ITEMGEN_QUALITYMOD_COMMON,
    CONFIG_ITEMGEN_QUALITYMOD_UNCOMMON,
    CONFIG_ITEMGEN_QUALITYMOD_RARE,
    CONFIG_ITEMGEN_QUALITYMOD_EPIC,
    CONFIG_ITEMGEN_QUALITYMOD_LEGENDARY,
    CONFIG_ITEMGEN_SPELL_CHANCE_POOR,
    CONFIG_ITEMGEN_SPELL_CHANCE_NORMAL,
    CONFIG_ITEMGEN_SPELL_CHANCE_UNCOMMON,
    CONFIG_ITEMGEN_SPELL_CHANCE_RARE,
    CONFIG_ITEMGEN_SPELL_CHANCE_EPIC,
    CONFIG_ITEMGEN_SPELL_CHANCE_LEGENDARY,
...
enum WorldIntConfigs : uint32
{
    ...
    CONFIG_ITEMGEN_QUALITY_UNCOMMON,
    CONFIG_ITEMGEN_QUALITY_RARE,
    CONFIG_ITEMGEN_QUALITY_EPIC,
    CONFIG_ITEMGEN_QUALITY_LEGENDARY,
    CONFIG_ITEMGEN_QUALITY_ARTIFACT,
    CONFIG_ITEMGEN_QUALITY_HEIRLOOM,
    CONFIG_ITEMGEN_STATSLOT_PRIMARY_COMMON,
    CONFIG_ITEMGEN_STATSLOT_PRIMARY_UNCOMMON,
    CONFIG_ITEMGEN_STATSLOT_PRIMARY_RARE,
    CONFIG_ITEMGEN_STATSLOT_PRIMARY_EPIC,
    CONFIG_ITEMGEN_STATSLOT_PRIMARY_LEGENDARY,
    CONFIG_ITEMGEN_STATSLOT_SECONDARY_COMMON,
    CONFIG_ITEMGEN_STATSLOT_SECONDARY_UNCOMMON,
    CONFIG_ITEMGEN_STATSLOT_SECONDARY_RARE,
    CONFIG_ITEMGEN_STATSLOT_SECONDARY_EPIC,
    CONFIG_ITEMGEN_STATSLOT_SECONDARY_LEGENDARY,
    CONFIG_MAX_TALENT_LEVEL,
    CONFIG_MAX_BONUS_TALENT_LEVEL,
    CONFIG_SOFT_MAX_ITEM_LEVEL,
    CONFIG_SCALING_MAX_ITEM_LEVEL,
    CONFIG_HARD_MAX_ITEM_LEVEL,
    CONFIG_ITEMGEN_SETCHANCE_COMMON,
    CONFIG_ITEMGEN_SETCHANCE_UNCOMMON,
    CONFIG_ITEMGEN_SETCHANCE_RARE,
...
enum Rates
{
    ...
    RATE_CREATURE_SPELL_DMG_50,
    RATE_CREATURE_SPELL_DMG_65,
    RATE_CREATURE_SPELL_DMG_100,
    RATE_CREATURE_SPELL_DMG_150,
    RATE_CREATURE_SPELL_DMG_200,
    RATE_CREATURE_SPELL_DMG_250,
    RATE_CREATURE_SPELL_DMG_300,
    RATE_CREATURE_SPELL_DMG_310,
    RATE_CREATURE_SPELL_DMG_320,
    RATE_CREATURE_SPELL_DMG_325,
    RATE_PLAYER_PET_ITEM_SCALE,
    MAX_RATES
};
