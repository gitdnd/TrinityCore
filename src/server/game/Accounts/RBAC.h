...
enum RBACPermissions
{
    ...
    RBAC_PERM_COMMAND_DISCORD_FORGOT_PASSWORD               = 1000,
    RBAC_PERM_COMMAND_DISCORD_FORGOT_USERNAME               = 1001,
    RBAC_PERM_COMMAND_DISCORD_CHANGE_PASSWORD               = 1002,
    RBAC_PERM_COMMAND_DISCORD_SETUP_2FA                     = 1003,
    RBAC_PERM_COMMAND_DISCORD_REGISTER_ACCOUNT              = 1004,
    RBAC_PERM_COMMAND_DISCORD_REGISTER_ACCESS_KEY           = 1005,
    RBAC_PERM_COMMAND_DISCORD_ACCOUNT_STATUS                = 1006,
    RBAC_PERM_MAX
};
