...
{
    STAT_GROUP_MASK_INT_HEALING = 1,
    STAT_GROUP_MASK_INT_DPS = 2,
    STAT_GROUP_MASK_SPI_DPS = 4,
    STAT_GROUP_MASK_SPI_HEALING = 8,
    STAT_GROUP_MASK_STR_DPS = 16,
    STAT_GROUP_MASK_AGI_DPS = 32,
    STAT_GROUP_MASK_STR_PARRY_TANK = 64,
    STAT_GROUP_MASK_STR_BLOCK_TANK = 128,
    STAT_GROUP_MASK_AGI_DODGE_TANK = 256,
    STAT_GROUP_MASK_AGI_BLOCK_TANK = 512,
    STAT_GROUP_MASK_INT = 1024,
    STAT_GROUP_MASK_SPI = 2048,
    STAT_GROUP_MASK_STR = 8192,
    STAT_GROUP_MASK_AGI = 16384,
    STAT_GROUP_MASK_CASTER = 32768,
    STAT_GROUP_MASK_HEALING = 65536,
    STAT_GROUP_MASK_MELEE_DPS = 131072,
    STAT_GROUP_MASK_TANK = 262144,
    STAT_GROUP_MASK_MELEE = 524288,
    STAT_GROUP_MASK_RANGED = 1048576,
    STAT_GROUP_MASK_DPS = 2097152,
};
