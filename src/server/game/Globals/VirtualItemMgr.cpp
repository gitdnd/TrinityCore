...
void VirtualItemMgr::GenerateItemLevel(VirtualItemTemplate* output, VirtualModifier& modifier) const
{
    ...
    // Hard cap of 325 across all items
...
uint32 VirtualItemMgr::StatGroupToMask(uint32 statGroupId)
{
    ...
    case STAT_GROUP_INT_HEALING:
    {
        return STAT_GROUP_MASK_HEALING | STAT_GROUP_MASK_INT | STAT_GROUP_MASK_CASTER | STAT_GROUP_MASK_INT_HEALING;
    }break;
    case STAT_GROUP_INT_DPS:
    {
        return STAT_GROUP_MASK_DPS | STAT_GROUP_MASK_INT | STAT_GROUP_MASK_CASTER | STAT_GROUP_MASK_INT_DPS;
    }break;
    case STAT_GROUP_STR_DPS_NO_HIT:
    {
        return STAT_GROUP_MASK_DPS | STAT_GROUP_MASK_STR | STAT_GROUP_MASK_MELEE | STAT_GROUP_MASK_MELEE_DPS | STAT_GROUP_MASK_STR_DPS;
    }break;
    case STAT_GROUP_STR_PARRY_TANK:
    {
        return STAT_GROUP_MASK_TANK | STAT_GROUP_MASK_STR | STAT_GROUP_MASK_MELEE | STAT_GROUP_MASK_STR_PARRY_TANK;
    }break;
    case STAT_GROUP_AGI_DPS_NO_HIT:
    {
        return STAT_GROUP_MASK_DPS | STAT_GROUP_MASK_AGI | STAT_GROUP_MASK_MELEE | STAT_GROUP_MASK_MELEE_DPS | STAT_GROUP_MASK_AGI_DPS;
    }break;
    case STAT_GROUP_AGI_DODGE_TANK:
    {
        return STAT_GROUP_MASK_TANK | STAT_GROUP_MASK_AGI | STAT_GROUP_MASK_MELEE | STAT_GROUP_MASK_AGI_DODGE_TANK;
    }break;
    case STAT_GROUP_SPI_DPS:
    {
        return STAT_GROUP_MASK_DPS | STAT_GROUP_MASK_SPI | STAT_GROUP_MASK_CASTER | STAT_GROUP_MASK_SPI_DPS;
    }break;
    case STAT_GROUP_SPI_HEALING:
    {
        return STAT_GROUP_MASK_HEALING | STAT_GROUP_MASK_SPI | STAT_GROUP_MASK_CASTER | STAT_GROUP_MASK_SPI_HEALING;
    }break;
    case STAT_GROUP_STR_DPS_NO_EXP:
    {
        return STAT_GROUP_MASK_DPS | STAT_GROUP_MASK_STR | STAT_GROUP_MASK_MELEE_DPS | STAT_GROUP_MASK_STR_DPS;
    }break;
    case STAT_GROUP_STR_BLOCK_TANK:
    {
        return STAT_GROUP_MASK_TANK | STAT_GROUP_MASK_STR | STAT_GROUP_MASK_MELEE | STAT_GROUP_MASK_STR_BLOCK_TANK;
    }break;
    case STAT_GROUP_AGI_DPS_NO_EXP:
    {
        return STAT_GROUP_MASK_DPS | STAT_GROUP_MASK_AGI | STAT_GROUP_MASK_RANGED | STAT_GROUP_MASK_AGI_DPS;
    }break;
    case STAT_GROUP_AGI_BLOCK_TANK:
    {
        return STAT_GROUP_MASK_TANK | STAT_GROUP_MASK_STR | STAT_GROUP_MASK_MELEE | STAT_GROUP_MASK_AGI_BLOCK_TANK;
    }break;
    case STAT_GROUP_ALL:
    ...
    default:
    {
        return STAT_GROUP_MASK_HEALING | STAT_GROUP_MASK_DPS | STAT_GROUP_MASK_TANK | STAT_GROUP_MASK_INT |
            STAT_GROUP_MASK_SPI | STAT_GROUP_MASK_STR | STAT_GROUP_MASK_AGI | STAT_GROUP_MASK_CASTER | STAT_GROUP_MASK_MELEE |
            STAT_GROUP_MASK_RANGED | STAT_GROUP_MASK_MELEE_DPS | STAT_GROUP_MASK_INT_HEALING | STAT_GROUP_MASK_INT_DPS | STAT_GROUP_MASK_STR_DPS |
            STAT_GROUP_MASK_STR_PARRY_TANK | STAT_GROUP_MASK_AGI_DPS | STAT_GROUP_MASK_AGI_DODGE_TANK | STAT_GROUP_MASK_SPI_DPS | STAT_GROUP_MASK_SPI_HEALING |
            STAT_GROUP_MASK_STR_BLOCK_TANK | STAT_GROUP_MASK_AGI_BLOCK_TANK;
    }break;
    }
    return 0;
}
