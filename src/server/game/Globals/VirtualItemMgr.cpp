    ...
    if (output->Class == ITEM_CLASS_WEAPON)
    {
        switch (output->SubClass)
        {
            ...
            case ITEM_SUBCLASS_WEAPON_STAFF:
            {
                ...
                output->Damage[0].DamageMin = ((1.08f * ilevel) * 0.85f) * (float)(output->Delay / 1000);
                output->Damage[0].DamageMax = ((1.08f * ilevel) * 1.15f) * (float)(output->Delay / 1000);
            ...
            case ITEM_SUBCLASS_WEAPON_DAGGER:
            {
                ...
                output->Damage[0].DamageMin = ((0.83f * ilevel) * 0.85f) * (float)(output->Delay / 1000);
                output->Damage[0].DamageMax = ((0.83f * ilevel) * 1.15f) * (float)(output->Delay / 1000);
                output->Damage[0].DamageType = 0;
                break;
            }
            ...
            case ITEM_SUBCLASS_WEAPON_CROSSBOW:
            {
                ...
                output->Damage[0].DamageMin = ((0.93f * ilevel) * 0.85f) * (float)(output->Delay / 1000);
                output->Damage[0].DamageMax = ((0.93f * ilevel) * 1.15f) * (float)(output->Delay / 1000);
                output->Damage[0].DamageType = 0;
                break;
            }
            case ITEM_SUBCLASS_WEAPON_WAND:
            {
                ...
                output->Damage[0].DamageMin = ((1.5f * ilevel) * 0.85f) * (float)(output->Delay / 1000);
                output->Damage[0].DamageMax = ((1.5f * ilevel) * 1.15f) * (float)(output->Delay / 1000);
