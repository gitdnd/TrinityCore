...
void ObjectMgr::LoadVirtualItemTemplates()
{
    ...
    QueryResult result = CharacterDatabase.Query("SELECT entry, base_entry, name, Quality, displayId, ItemLevel, StatsCount, "
        ...
        "dmg_min1, dmg_max1, dmg_type1, delay, armor, bonding, description, block, itemset, socket1, socket2, socket3, DisenchantID, spellid_1, spelltrigger_1, spellcharges_1, spellppmRate_1, spellcooldown_1, spellcategory_1, spellcategorycooldown_1, spellid_2, spelltrigger_2, spellcharges_2, spellppmRate_2, spellcooldown_2, spellcategory_2, spellcategorycooldown_2, spellid_3, spelltrigger_3, spellcharges_3, spellppmRate_3, spellcooldown_3, spellcategory_3, spellcategorycooldown_3, spellid_4, spelltrigger_4, spellcharges_4, spellppmRate_4, spellcooldown_4, spellcategory_4, spellcategorycooldown_4, spellid_5, spelltrigger_5, spellcharges_5, spellppmRate_5, spellcooldown_5, spellcategory_5, spellcategorycooldown_5, seed "
