...
SpellEffectInfo::StaticData SpellEffectInfo::_data[TOTAL_SPELL_EFFECTS] =
{
    ...
    { EFFECT_IMPLICIT_TARGET_CASTER, TARGET_OBJECT_TYPE_UNIT }, // 174 SPELL_EFFECT_PCT_XP_GAIN
    { EFFECT_IMPLICIT_TARGET_CASTER, TARGET_OBJECT_TYPE_UNIT }, // 175 SPELL_EFFECT_XP_GAIN
