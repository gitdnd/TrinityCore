...
{ {
    ...
    { EFFECT_IMPLICIT_TARGET_EXPLICIT, TARGET_OBJECT_TYPE_ITEM }, // 168 SPELL_EFFECT_VIRTUAL_ITEM_QUALITY_UPGRADE
    { EFFECT_IMPLICIT_TARGET_EXPLICIT, TARGET_OBJECT_TYPE_ITEM }, // 169 SPELL_EFFECT_VIRTUAL_ITEM_LEVEL_UPGRADE
    { EFFECT_IMPLICIT_TARGET_EXPLICIT, TARGET_OBJECT_TYPE_ITEM }, // 170 SPELL_EFFECT_REMOVE_STAT_FROM_VIRTUAL_ITEM
    ...
    { EFFECT_IMPLICIT_TARGET_EXPLICIT, TARGET_OBJECT_TYPE_UNIT }, // 174 SPELL_EFFECT_PCT_XP_GAIN
    { EFFECT_IMPLICIT_TARGET_EXPLICIT, TARGET_OBJECT_TYPE_UNIT }, // 175 SPELL_EFFECT_XP_GAIN
    { EFFECT_IMPLICIT_TARGET_EXPLICIT, TARGET_OBJECT_TYPE_ITEM }, // 176 SPELL_EFFECT_HONE_VIRTUAL_ITEM
    { EFFECT_IMPLICIT_TARGET_EXPLICIT, TARGET_OBJECT_TYPE_UNIT }, // 177 SPELL_EFFECT_ADD_BONUS_TALENT
...
{
    if (Id == 53201 || Id == 53007 || Id == 48156 || Id == 42846 || Id == 47820 || Id == 42940) // Damage done by triggered spells so needs hacked.
        return true;
