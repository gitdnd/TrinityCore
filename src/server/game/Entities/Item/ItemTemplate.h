...
enum ItemFlagsCustom
{
    ...
    ITEM_FLAGS_CU_VIRTUAL_ITEM_STATIC   = 0x0010,
    ITEM_FLAGS_CU_VIRTUAL_ITEM_DISPLAY_STATIC = 0x0020,
...
#define SOCKET_COLOR_PRISMATIC (SOCKET_COLOR_BLUE | SOCKET_COLOR_RED| SOCKET_COLOR_YELLOW)
