...
#define SOCKET_COLOR_ALL (SOCKET_COLOR_META | SOCKET_COLOR_RED | SOCKET_COLOR_YELLOW | SOCKET_COLOR_BLUE | SOCKET_COLOR_ORANGE | SOCKET_COLOR_PURPLE | SOCKET_COLOR_GREEN)
...
enum ItemSubclassGem
{
    ...
    ITEM_SUBCLASS_GEN_HARMONY                   = 12
};

#define MAX_ITEM_SUBCLASS_GEM                     13
...
enum ItemSubclassRecipe
{
    ...
    ITEM_SUBCLASS_TRANSMUTATION_RECIPE          = 11
};
