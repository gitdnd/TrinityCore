...
enum PlayerLoginQueryIndex
{
    ...
    PLAYER_LOGIN_QUERY_LOAD_HIGHEST_SLOT_LEVELS,
    PLAYER_LOGIN_QUERY_LOAD_NUM_LEARNT_TALENTS,
    PLAYER_LOGIN_QUERY_LOAD_CUSTOM_TALENTS,
...
class TC_GAME_API Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        static bool BuildEnumData(PreparedQueryResult result, WorldPacket* data, WorldSession* session);
        ...
        uint8 GetEquipSlot(ItemTemplate const* proto) const;
        ...
        Item* StoreNewItem2(ItemPosCountVec const& pos, uint32 item, bool update, int32 randomPropertyId = 0, bool isCrafted = false, GuidSet const& allowedLooters = GuidSet())
        {
        ...
        void AutoStoreLootNonPersonal(uint32 loot_id, LootStore const& store, bool broadcast = false, bool createdByPlayer = false, bool canBePersonal = true) { AutoStoreLoot(NULL_BAG, NULL_SLOT, loot_id, store, broadcast, createdByPlayer, canBePersonal); }
        ...
        bool CanStillReachRootTalentNode(const TalentNodeInfo* nodeInfo, uint32 excludeNode);
