...
TC_API_EXPORT EnumText EnumUtils<CreatureFlagsExtra>::ToString(CreatureFlagsExtra value)
{
    switch (value)
    {
        ...
        case CREATURE_FLAG_EXTRA_IGNORE_AFFIX: return { "CREATURE_FLAG_EXTRA_IGNORE_AFFIX", "CREATURE_FLAG_EXTRA_IGNORE_AFFIX", "creature is immune to affix auras and effects." };
...
TC_API_EXPORT CreatureFlagsExtra EnumUtils<CreatureFlagsExtra>::FromIndex(size_t index)
{
    switch (index)
    {
        ...
        case 31: return CREATURE_FLAG_EXTRA_IGNORE_AFFIX;
...
TC_API_EXPORT size_t EnumUtils<CreatureFlagsExtra>::ToIndex(CreatureFlagsExtra value)
{
    switch (value)
    {
        ...
        case CREATURE_FLAG_EXTRA_IGNORE_AFFIX: return 31;
        default: throw std::out_of_range("value");
    }
}
}
