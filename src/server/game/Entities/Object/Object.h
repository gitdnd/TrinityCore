...
class TC_GAME_API WorldObject : public Object, public WorldLocation
{
    ...
    public:
        ...
        TempSummon* SummonCreature(uint32 entry, Position const& pos, TempSummonType despawnType, Milliseconds despawnTime, uint32 vehId = 0, uint32 spellId = 0, int dungeonLevel = 0)
        {
            return SummonCreature(entry, pos, despawnType, uint32(despawnTime.count()), vehId, spellId, dungeonLevel);
        }
